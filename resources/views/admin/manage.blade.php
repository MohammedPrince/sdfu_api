        ...
        <div class="admin-card">
            ...
            <div class="admin-card-header">
                <div>
                    ...
                    <p>
                        Select Faculty, Major, Batch and Semester to control which application
                        features are available to students.
                    </p>
                </div>
            </div>
                    ...
                    <div class="status-list">
                        ...
                        <div class="status-item">
                            <div class="status-info">
                                ...
                                <span>Allow students to access the application.</span>
                            </div>
                        ...
                        <div class="status-item">
                            <div class="status-info">
                                <strong>Fees</strong>
                                <span>Allow students to view current semester fees.</span>
                            </div>
                        ...
                        <div class="status-item">
                            <div class="status-info">
                                ...
                                <span>Allow students to view their semester result.</span>
                            </div>
                        ...
                        <div class="status-item">
                            <div class="status-info">
                                ...
                                <span>Allow students to view their timetable.</span>
                            </div>
            ...
            <div class="admin-card saved-settings-card">
                ...
                @if ($savedSettings->isEmpty())
                    ...
                    <div class="empty-state">
                        <p>No application settings have been saved yet.</p>
                    </div>
                @else
                        ...
                        <table class="settings-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($savedSettings as $setting)
                                    <tr>
                                        <td>{{ $setting['faculty_desc_e'] }}</td>
                                        <td>{{ $setting['major_desc_e'] }}</td>
                                        <td>{{ $setting['batch'] }}</td>
